...
@section('content-dashboard')
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('diary-content.delete', ['content_id' => $_GET['content_id'], 'diarycontent_id' => $content->diarycontent_id]) }}"
                                            onclick="return confirm('Bạn chắc chắn xóa');" class="px-2" href=""><span
    ...
    <script>
        function changeStatus(id, div) {
            ...
            $.ajax({
                url: "{{ route('diary-content.status') }}", // đường dẫn khi gửi dữ liệu đi 'search' là tên route mình đặt bạn mở route lên xem là hiểu nó là cái j.
